...
for iter = 26:26
    ...
    if clustering(1)
        ...
        [Clases, Centroides, ~, ~] = kmeans(double(patrones),k,'MaxIter', 5000,'Distance', 'sqeuclidean', 'Start', initialCentroids,'EmptyAction','singleton');
...
%   tolerancia = 9.562263;
    ...
    guardarResultados(im2uint8(ImagenReconstruida), segmentos, 0, datos, rutaGuardar, rutaImagenes, Nombres, iter, u, 0, fg2, tiempoTotal);
    clear TiempoInicial imagenOriginal imagen
    close all
    disp(iter)
end